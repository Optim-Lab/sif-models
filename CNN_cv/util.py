...
def argparse_custom():
    ...
    parser.add_argument("-hidden", type=int, default=[16], nargs=1, help="hidden_dim")
    parser.add_argument("-k", type=int, default=[3], nargs=1, help="kernel_size")
    parser.add_argument("-nl", type=int, default=[2], nargs=1, help="num_layers")
    parser.add_argument("-y", type=int, default=[2], nargs=1, help="test_years")
    parser.add_argument("-ci", type=int, default=[1], nargs=1, help="cv index")
